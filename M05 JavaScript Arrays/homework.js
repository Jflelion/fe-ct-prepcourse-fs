...
function promedioResultadosTest(resultadosTest) {
   ...
   // Tu código:
   var sum = resultadosTest.reduce((acc, curr) => acc + curr, 0);
...
function mesesDelAño(array) {
   ...
   return mesesEncontrados.length === 3 ? mesesEncontrados : "No se encontraron los meses pedidos";
}
